  ...
  return (
    <div className="flex items-center justify-center gap-2">
      <button
        ...
        className="p-1 border-1 border-primary-light bg-gray-100 dark:bg-gray-700 rounded-sm hover:bg-gray-200/80 hover:dark:bg-gray-700/80 hover:cursor-pointer disabled:cursor-default"
      >
